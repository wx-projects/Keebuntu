...
install -m 0644 "$SOURCE_DIR/plugins/GtkStatusIcon.dll" "$PLUGIN_DEST/"
cp -a "$SOURCE_DIR/icons/." "$ICON_DEST/"

test -f "$PLUGIN_DEST/GtkStatusIcon.dll"

echo "Installed Keebuntu GTK Status Icon into $PLUGIN_DEST"
